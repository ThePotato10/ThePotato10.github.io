...
const questions = [
    ...
    new Question(4, "Danced without leaving room for Jesus?",                                                                          3),
    ...
    new Question(9, "Kissed on the neck?",                                                                                             3),
    new Question(10, "Kissed horizontally?",                                                                                           3),
    new Question(11, "Given or received a hickey?",                                                                                    3),
    new Question(12, "Kissed or been kissed on the breast?",                                                                           4),
    ...
    new Question(25, "Undressed or been undressed by a MPS?",                                                                          4),
    ...
    new Question(31, "Had an orgasm due to someone else's manipulation?",                                                              5),
    new Question(32, "Sent a sexually explicit text or instant message?",                                                              4),
    new Question(33, "Sent or received explicit photographs?",                                                                         5),
    new Question(34, "Engaged in sexually explicit activity over video chat?",                                                         5),
    new Question(35, "Cheated on a significant other?",                                                                                6),
    new Question(36, "Purchased contraceptives?",                                                                                      5),
    new Question(37, "Gave oral sex?",                                                                                                 5),
    new Question(38, "Received oral sex?",                                                                                             5),
    new Question(39, "Ingested someone else's genital secretion?",                                                                     5),
    new Question(40, "Used a sex toy with a partner?",                                                                                 5),
    new Question(41, "Spent the night with an MPS?",                                                                                   5),
    ...
    new Question(45, "Played a drinking game?",                                                                                        4),
    new Question(46, "Been drunk?",                                                                                                    4),
    new Question(47, "Faked sobriety to parents or teachers?",                                                                         5),
    new Question(48, "Had severe memory loss due to alcohol?",                                                                         5),
    new Question(49, "Used tobacco?",                                                                                                  4),
    new Question(50, "Used marijuana?",                                                                                                3),
    new Question(51, "Used a drug stronger than marijuana?",                                                                           5),
    new Question(52, "Used methamphetamine, crack cocaine, PCP, horse tranquilizers or heroin?",                                       9),
    new Question(53, "Been sent to the office of a principal, dean or judicial affairs representative for a disciplinary infraction?", 5),
    new Question(54, "Been put on disciplinary probation or suspended?",                                                               6),
    new Question(55, "Urinated in public?",                                                                                            4),
    new Question(56, "Gone skinny-dipping?",                                                                                           5),
    new Question(57, "Gone streaking?",                                                                                                5),
    new Question(58, "Seen a stripper?",                                                                                               5),
    new Question(59, "Had the police called on you?",                                                                                  4),
    ...
    new Question(65, "Been convicted of a felony?",                                                                                    9),
    new Question(66, "Committed an act of vandalism?",                                                                                 5),
    new Question(67, "Had sexual intercourse?",                                                                                        5),
    ...
    new Question(71, "Had sexual intercourse with a person you've known for less than 24 hours?",                                      6),
    new Question(72, "Had sexual intercourse in at least 4 distinct positions?",                                                       6),
    ...
    new Question(83, "Had sexual intercourse with a partner with at least a 3 year age difference?",                                   7),
    new Question(84, "Had sexual intercourse with a virgin?",                                                                          6),
    new Question(85, "Had sexual intercourse without a condom?",                                                                       6),
    new Question(86, "Had a STI test due to reasonable suspicion?",                                                                    7),
    new Question(87, "Had a STI?",                                                                                                     8),
    new Question(88, "Had a threesome?",                                                                                               6),
    new Question(89, "Attended an orgy?",                                                                                              8),
    new Question(90, "Had two or more distinct acts of sexual intercourse with at least 2 partners in one night?",                     7),
    ...
    new Question(94, "Had anal sex?",                                                                                                  7),
    new Question(95, "Had a pregnancy scare?",                                                                                         8),
    new Question(96, "Impregnated someone or been impregnated?",                                                                       9),
    ...
    new Question(100, "Engaged in bestiality?",                                                                                        9),
];
...
const toggleScore = () => {
    if (!isScoreVisible) {
        ...
        document.querySelector(".score-container").textContent = `You Scored ${100 - (score / 5)}`;
    } else {
